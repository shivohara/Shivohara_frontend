...
// Project Portfolio Data — Our Works (Client Projects)
const PROJECTS = [
  {
    id: 1,
...
const OUR_PRODUCTS = [
  {
    id: 'velish',
    title: 'Velish',
    tagline: 'Smart Campus Food Ordering',
    description: 'A campus food ordering and smart cafeteria management platform designed for colleges and universities. Velish transforms how students and faculty experience campus dining — with real-time menus, instant ordering, queue-free pickups, and AI-powered meal recommendations.',
    image: '/velish.png',
    imageBackground: '#000000',
    link: 'https://velish.in',
    features: [
      'Real-time menu & availability',
      'Instant QR-based ordering',
    ...
    stats: [
      ...
      { label: 'Campus Partners', value: '5+' },
      { label: 'Avg. Wait Reduction', value: '70%' }
    ]
  }
];
...
export default function App() {
  ...
  // --- Counting Animation for Product Stats ---
  useEffect(() => {
    const el = productStatsRef.current;
    if (!el) return;
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            statTimersRef.current.forEach(clearInterval);
            statTimersRef.current = [];

            OUR_PRODUCTS.forEach((product) => {
              product.stats.forEach((stat, i) => {
                ...
                const timer = setInterval(() => {
                  ...
                  setCountedStats((prev) => ({
                    ...prev,
                    [`${product.id}-${i}`]: current.toLocaleString() + suffix
                  }));
                  if (step >= steps) clearInterval(timer);
                }, duration / steps);

                statTimersRef.current.push(timer);
              });
            });
          } else {
            // Clear timers
            ...
            // Reset stats when scrolled out of view
            OUR_PRODUCTS.forEach((product) => {
              product.stats.forEach((stat, i) => {
                setCountedStats((prev) => ({
                  ...prev,
          ...
          <section className="our-products-section reveal-on-scroll" id="our-products">
            <div className="container">
              <div className="our-products-header">
                ...
                <p className="section-subtitle">Products we've conceptualized, designed, and engineered from the ground up — solving real-world problems at scale.</p>
              </div>
                ...
                <div className="product-showcase" key={product.id}>
                  <div className="product-hero-card" ref={productStatsRef}>
                    ...
                    <div className="product-hero-content">
                      ...
                      <a href={product.link} target="_blank" rel="noopener noreferrer" className="product-cta-btn">
                  ...
                  <div className="contact-info-cards contact-animate-item">
                    <div className="contact-info-card">
                      ...
                      <div className="contact-info-card-body">
                        <h4>Email Us</h4>
                        <p>shivoharatechnologies@gmail.com</p>
